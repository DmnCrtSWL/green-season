    ...
    <section style={heroStyle}>
      <div style={leftColumnStyle}>
        <ParallaxText speed={0.15}>
          <img src="/logo-verde.png" alt="Green Season Turf & Landscaping LLC" style={{ maxWidth: '300px', marginBottom: '1.5rem' }} />
          <p style={subtitleStyle}>
            Stands out for its high-quality work and the confidence built through satisfied customers. We take pride in delivering great results and seeing our clients happy with every project.
          </p>
          <button style={buttonStyle} className="hero-button">Get a Quote</button>
        </ParallaxText>
      </div>
